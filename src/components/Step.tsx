		...
		<section className="mx-auto w-full max-w-7xl overflow-hidden px-4 py-16">
			<div className="flex flex-col-reverse items-center gap-12 lg:flex-row lg:items-start lg:justify-between">
				...
				<div className="flex w-full justify-center lg:max-w-md">
					<motion.img src={StepsImg.src} className="w-full max-w-xl" draggable={false} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.8, ease: [0.42, 0, 0.58, 1], delay: 0.4 }} />
				</div>
			</div>
		</section>
	);
