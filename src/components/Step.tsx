...
const steps = [
  {
    ...
    content:
      "Ambil atau pilih foto tanaman yang ingin kamu identifikasi melalui aplikasi Daunesia.",
  },
  {
    title: "Biarkan AI menganalisis gambar",
    content:
      "Teknologi AI kami akan memproses gambar dan mencocokkannya dengan database tanaman herbal Indonesia.",
  },
  {
    title: "Hasil instan dengan informasi penting",
    content:
      "Kamu akan langsung melihat nama tanaman, manfaat, dan deskripsinya.",
  },
  {
        ...
        <div className="flex w-full flex-col gap-2.5 lg:w-2/4">
          ...
          >
            <h6 className="text-font-primary text-2xl md:text-3xl font-bold">
              Bagaimana daunesia bekerja
            </h6>
            <p className="text-font-primary md:text-lg">
              Empat langkah mudah untuk mengenal kekayaan herbal Indonesia.
            </p>
          </motion.div>
          <ul className="flex flex-col gap-4 md:gap-6">
            {steps.map((step, i) => (
              ...
              >
                ...
                >
                  <div className="bg-green-light text-font-primary flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full font-bold">
                    {i + 1}
                  </div>
                  <span className="text-font-primary mt-1 flex-1 text-base font-medium">
                    {step.title}
                  </span>
                  <motion.div
                    className="text-font-primary ml-auto flex items-center"
                ...
                <AnimatePresence initial={false}>
                  {openIndex === i && (
                    <motion.div
                      className="text-font-secondary ml-12 overflow-hidden text-sm"
