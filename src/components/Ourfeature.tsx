        ...
        <section className="flex flex-col items-center gap-12 py-12">
            <div className="flex w-full max-w-7xl flex-col items-center gap-3 px-5">
                ...
                <div className="flex flex-col gap-1 text-center">
                    ...
                    <p className="text-font-primary w-200 text-lg font-normal">Daunesia menggabungkan kearifan lokal dengan teknologi modern untuk membantumu memahami tanaman di sekitarmu.</p>
                </div>

                {/* Cards */}
                <div className="mt-8 grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {features.map((item, index) => (
                        <div key={index} className="border-green-secondary rounded-xl border p-6 text-left shadow-sm">
