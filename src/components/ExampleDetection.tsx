            ...
            <div className="flex flex-row items-center gap-2">
                {data.id == "point1" && (
                    <svg className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.33398 10.5C2.33398 13.5942 3.56315 16.5617 5.75107 18.7496C7.939 20.9375 10.9065 22.1667 14.0007 22.1667C17.0948 22.1667 20.0623 20.9375 22.2502 18.7496C24.4382 16.5617 25.6673 13.5942 25.6673 10.5" stroke="#73946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M25.6673 10.5C22.5731 10.5 19.6057 11.7292 17.4177 13.9171C15.2298 16.105 14.0007 19.0725 14.0007 22.1667C14.0007 20.6346 13.6989 19.1175 13.1126 17.702C12.5263 16.2866 11.6669 15.0004 10.5836 13.9171C9.50021 12.8337 8.21409 11.9744 6.79862 11.3881C5.38316 10.8018 3.86607 10.5 2.33398 10.5" stroke="#73946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M17.4888 13.4165C17.5699 11.7931 17.3002 10.1712 16.6983 8.66131C16.0964 7.15141 15.1762 5.7889 14.0005 4.6665C12.8247 5.7889 11.9046 7.15141 11.3026 8.66131C10.7007 10.1712 10.4311 11.7931 10.5121 13.4165" stroke="#73946B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                )}
                {data.id == "point2" && (
                    <svg className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const ContohDeteksi = () => {
    ...
    const totalHeight = positionedData.reduce((acc, item) => acc + item.nodeHeight + 20, 0) + 0; // add some padding
