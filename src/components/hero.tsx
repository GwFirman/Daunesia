    ...
    return (
        <section className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-12 px-5 py-16">
            <div className="flex flex-1 flex-col-reverse items-center justify-center gap-8 lg:flex-row lg:justify-between">
                <div className="relative mt-8 flex w-full max-w-lg flex-col gap-4">
                    ...
                    <motion.p
                        ...
                        className="text-font-primary text-xl font-light"
                    >
                    ...
                    <motion.div
                        ...
                        className="relative flex w-full max-w-sm flex-col gap-4 lg:flex-row"
                    >
            ...
            <motion.div
                ...
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 2.1, duration: 1.2, ease: [0.42, 0, 0.58, 1] }}
                className="border-green-primary mt-12 flex h-70 w-full flex-col items-center justify-center gap-4 rounded-2xl border-[3px] border-dashed shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)]"
            >
