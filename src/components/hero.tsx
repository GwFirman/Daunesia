...
const Hero = () => {
	return (
		<section className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-12 px-5 py-16">
			...
			<motion.div initial={{ y: 40, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 2.1, duration: 1.2, ease: [0.42, 0, 0.58, 1] }} className="border-green-primary mt-12 flex h-70 w-full flex-col items-center justify-center gap-4 rounded-2xl border-[3px] border-dashed shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)]">
