...
import contohDeteksi from "@/assets/images/contohDeteksi2.svg";
  ...
  async function mulaiDeteksi(): Promise<any> {
    ...
    try {
      ...
      if (result.data && result.data.length >= 3) {
        ...
        if (
          detectedPlantName &&
          detectedPlantName !== "Gambar tidak terdeteksi sebagai tanaman."
        ) {
        ...
        >
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <div className="flex gap-2 mt-4">
              <button
                ...
                disabled={isLoading}
                className="cursor-pointer flex-1 flex items-center justify-center gap-2 rounded-full bg-green-secondary lg:px-5 lg:py-2 text-white disabled:opacity-50 disabled:cursor-not-allowed hover:bg-green-primary transition-colors"
              >
                Bersihkan
              </button>
              <button
          ...
          <div className="bg-white  rounded-xl w-full shadow-lg px-2 pt-4 pb-4">
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="flex flex-row gap-1 lg:gap-2 justify-between items-center max-w-sm">
                {contohImages.map((img, i) => (
                  <img
                    ...
                    className="cursor-pointer w-22 md:w-24 lg:w-28 aspect-square object-cover hover:scale-102 transition-transform rounded-sm"
                  />
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-row flex-wrap gap-3">
            ...
            {!isLoggedIn && remainingTrials !== null && (
              <motion.div
                ...
                className="rounded-lg border-l-4 border-green-secondary bg-white p-2 lg:p-3 text-sm shadow-md max-w-max text-center"
              >
            ...
            {isLoggedIn && (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: 0.3 }}
                className="rounded-lg border-l-4 border-green-secondary bg-green-50 p-2 lg:p-3 text-sm shadow-md max-w-max text-center"
              >
                <div className="flex items-center gap-2">
                  <svg
                    className="h-5 w-5 text-green-secondary"
        ...
        <AnimatePresence mode="wait">
          {!result && (
            <motion.div
              ...
              className="lg:flex w-full flex-col gap-6 lg:w-5/8 hidden"
            >
                  ...
                  {plantName === "Gambar tidak terdeteksi sebagai tanaman." ? (
                    ...
                    <>
                      ...
                      <div className="bg-green-50-50 border border-green-200 rounded-lg p-4">
                        ...
                        <ul className="text-teal-950 text-sm space-y-1 list-disc list-inside">
                          ...
                          <li>
                            Gunakan pencahayaan yang cukup dan fokus yang tajam
                          </li>
                    ...
                    <>
                      <div className="border-b pb-4">
                        ...
                        <p className="text-font-primary text-sm">
                          Tanaman berhasil diidentifikasi dengan tingkat
                          kepercayaan tinggi
                        </p>
                      </div>
