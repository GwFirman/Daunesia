          ...
          <div className="flex flex-1 flex-col rounded-2xl bg-white p-4">
            <div className="flex flex-row items-center m-2">
              ...
              <motion.div
                ...
                className="text-font-primary mr-4 ml-auto font-medium"
              >
            ...
            <div className="mt-18 flex flex-1 justify-center">
              <div className="flex w-full max-w-lg flex-1 flex-col gap-3">
                <div className="flex flex-col gap-1">
                  <motion.div className="text-font-primary text-4xl font-bold">
                    Buat Akun
                  </motion.div>
                  <div className="text-md text-font-secondary">
                    Gabung sekarang untuk mendeteksi semua tanaman herbal di
                    Indonesia
                  </div>
                </div>

                <div className="flex w-full flex-col gap-2">
                  <div className="text-font-primary text-sm font-medium">
                    Username
                  </div>
                  <Input
                    type="text"
                    ...
                    className="placeholder:text-font-secondary border-font-secondary text-font-primary h-10 rounded-lg border-2 bg-white px-4"
                  />
                </div>
                ...
                <div className="flex w-full flex-col gap-2">
                  ...
                  <Input
                    ...
                    className="placeholder:text-font-secondary text-font-primary h-10 rounded-lg border-2 border-zinc-800/40 bg-white px-4"
                  />
                </div>
                ...
                <div className="flex w-full flex-col">
                  <div className="mt-3 w-full">
                    <Button
                      ...
                      className="h-12 w-full cursor-pointer rounded-lg font-medium text-white"
                      style={{
                        background:
                          "linear-gradient(to right, #537D5D, #73946B)",
                      }}
                    >
                      Daftar
                    </Button>
                ...
                <div className="mt-3 flex items-center gap-6">
                  ...
                  <div className="text-font-secondary text-base whitespace-nowrap">
                    atau daftar dengan
                  </div>
                  <div className="h-0.5 w-full rounded-lg bg-zinc-300" />
                </div>
                ...
                <div className="flex w-full flex-col gap-4 lg:flex-row">
                  ...
                  <div
                    ...
                    className="flex cursor-pointer h-12 w-full items-center justify-center gap-2 rounded-lg border-2 border-zinc-800/40 bg-white"
                  >
            ...
            {carouselData.map((slide, idx) => (
              <SwiperSlide key={idx}>
                <div className="relative h-full w-full">
                  <img
                    src={slide.image.src}
                    className="h-full w-full scale-105 object-cover transition-transform duration-1000 ease-in-out"
