							...
							<div className="flex w-full max-w-lg flex-1 flex-col gap-3">
								...
								<div className="flex w-full flex-col gap-4 lg:flex-row">
									...
									>
										...
										<div className="text-font-primary font-medium">{loadingProvider === "google" ? "Loading..." : "Google"}</div>
									</div>
									...
									>
										...
										<div className="text-font-primary font-medium">{loadingProvider === "facebook" ? "Loading..." : "Facebook"}</div>
									</div>
								</div>
							</div>
						</div>
