				...
				await authClient.signIn.social({
					...
					fetchOptions: {
						onError: () => {
							...
							toast.error("Gagal masuk", {
								description: `Tidak dapat masuk dengan ${provider === "google" ? "Google" : "Facebook"}`,
							});
							setLoadingProvider(null);
						},
					},
						...
						<div className="flex flex-1 flex-col rounded-2xl bg-white p-4">
							...
							<div className="mt-18 flex flex-1 justify-center">
								<div className="flex w-full max-w-lg flex-1 flex-col gap-4">
									...
									{/* Social Login */}
									<motion.div animate={{ y: [20, 0], opacity: [0, 1] }} transition={{ duration: 0.8, delay: 0.4 }} className="mt-4 flex w-full flex-col gap-4 cursor-pointer lg:flex-row">
										{/* Google */}
										<motion.div
