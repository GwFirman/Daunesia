  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        className="text-font-primary mx-auto mt-10 max-w-7xl rounded-lg bg-[linear-gradient(90deg,_#E6E3BD_30%,_#C6DBA5_54%,_#A2C59A_86%,_#7BAF84_100%)] px-4 py-16 shadow-md"
      >
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="flex flex-col gap-2">
            <h3 className="font-Playwrite_DK_Loopet sm:font-3xl text-2xl font-bold italic">
              Cara Modern Mengenal Herbal Lokal
            </h3>
            <p className="text-base leading-relaxed">
              Platform kami memberdayakan pengguna untuk menjelajahi tanaman herbal asli Indonesia melalui teknologi pengenalan daun berbasis AI. Cukup unggah foto untuk mengetahui nama tanaman, manfaat tradisional, dan nilai budayanya. Temukan kembali kearifan alam satu daun demi satu daun.
            </p>
          </div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mx-auto mt-16 grid w-full max-w-6xl grid-cols-1 gap-12 px-5 md:grid-cols-2 lg:grid-cols-3"
      >
